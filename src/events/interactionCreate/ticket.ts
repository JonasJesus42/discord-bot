...
import { buttonSendTicketComponent, Namespaces, selectComponent } from "../../pages/ticket";
        ...
        switch(namespace) {
            ...
            case Namespaces.select:
                ...
                if (interaction.isSelectMenu()) {
                    ...
                    return await interaction.editReply(buttonSendTicketComponent(selectMenuInteraction.values[0]));
                }
                return
